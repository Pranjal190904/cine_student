...
const feedbackController = {
    feedbackQuestions: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const feedbackQuestions = yield feedback_model_1.default.find();
